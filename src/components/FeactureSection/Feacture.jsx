...
const Feature = () => {
  ...
  return (
    <>
      ...
      <div className="bg-black text-gray-900 px-4 sm:px-10 md:px-20 py-12">
        {/* Hero Text */}
        <div className="text-center mb-10" data-aos="fade-up">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-snug bg-gradient-to-r text-white p-4 rounded-lg ">
        ...
        >
          ...
          <div className="w-full sm:w-1/2 mt-8 sm:mt-0">
            <h2 className="text-2xl sm:text-3xl font-semibold mb-6 bg-gradient-to-r  text-red-500 bg-clip-text ">
              Curated Range of Snacks
            </h2>
            <ul className="list-disc pl-5 space-y-2 text-white text-base sm:text-lg">
        ...
        >
          <div className="w-full sm:w-1/2 sm:ml-10 pr-4 sm:pr-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mb-3 bg-gradient-to-r  text-red-500 bg-clip-text ">
        ...
        >
          ...
          <div className="w-full sm:w-1/2">
            ...
            <ul className="space-y-2 text-base text-white sm:text-lg">
              <li>Product Categories:</li>
            </ul>
            <ul className="list-disc pl-5 space-y-2 mt-6 text-white text-base sm:text-lg">
        ...
        >
          <div className="w-full sm:w-1/2 sm:ml-10 pr-4 sm:pr-8">
            ...
            <h3 className="text-base text-white sm:text-lg font-semibold mb-3">
              Allow Vendiman to manage your pantry supplies through Smart Micro
              Retail Solutions.
            </h3>
            <ul className="space-y-2 text-base text-white sm:text-lg mt-4">
              <li>Product Categories:</li>
            </ul>
            <ul className="list-disc pl-5 space-y-2 text-white text-base sm:text-lg mt-6">
        ...
        {/* Why Choose Us */}
        <div
          className="bg-black text-gray-900 py-16 px-4 sm:px-10 md:px-20"
          data-aos="fade-up"
        >
          <h2 className="text-center text-2xl sm:text-3xl md:text-4xl font-bold mb-14 text-red-500 bg-clip-text ">
          ...
          <div
            className="bg-black px-4 sm:px-10 md:px-20 py-12"
            data-aos="fade-up"
          >
           

            <div className="text-center mb-10">
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-snug bg-gradient-to-r text-red-500 bg-clip-text ">
